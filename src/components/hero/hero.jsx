...
const hero = () => {
  return (
    ...
    <motion.div {...set} variants={container} className="md:leading-[7rem] leading-[4rem]">
      ...
      <motion.p variants={item(0.9)} className="text-xl font-medium">I’m a software engineer specializing in building (and occasionally designing) exceptional digital experiences. Currently, I’m focused on building accessible, human-centered products at</motion.p>
    </motion.div>
